...
export default function HomePage() {
  ...
  const markerHtml = useCallback((d: any) => {
    const a = d as FriendActivity;
    const avatar = getAvatarUrl(a);
    return `
      <div style="display:flex;align-items:center;gap:3px;background:white;border-radius:20px;padding:3px 8px 3px 3px;box-shadow:0 2px 8px rgba(0,0,0,0.3);cursor:pointer;white-space:nowrap;">
      ...
      <div ref={containerRef} className="relative mx-auto flex items-center justify-center overflow-hidden" style={{ height: globeWidth }}>
        {loading ? (
          ...
          <Globe
            ...
            htmlAltitude={0.05}
            onHtmlElementClick={(d: any) => navigate(`/place/${(d as FriendActivity).place_id}`)}
